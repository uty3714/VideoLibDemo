...
public abstract class IXzVideoController extends FrameLayout implements View.OnTouchListener{

    private Context mContext;
    protected IXzVideoPlayer mVideoPlayer;
    ...
    public IXzVideoController(@NonNull Context context) {
        super(context);
        mContext = context;
    }
    ...
    protected void startUpdateProgressTimer() {
        ...
        if (mUpdateProgressTimerTask == null) {
            mUpdateProgressTimerTask = new TimerTask() {
                @Override
                public void run() {
                    IXzVideoController.this.post(new Runnable() {
                        @Override
                        public void run() {
                            updateProgress();
                        }
    ...
    protected void pauseUpdateProgressTimer(){
        if (mUpdateProgressTimer != null) {
